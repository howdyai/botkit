...
controller.hears(['robot-button'], ['direct_mention', 'self_message', 'direct_message'], function(
    bot,
    message
) {
    let reply_message = {};
...
controller.hears(['robot-openlink'], ['direct_mention', 'self_message', 'direct_message'], function(
    bot,
    message
) {
    let reply_message = {};
...
controller.hears(
    ...
    ['direct_mention', 'self_message', 'direct_message'],
...
controller.hears(['robot-submit'], ['direct_mention', 'self_message', 'direct_message'], function(
    bot,
    message
) {
    let reply_message = {};
