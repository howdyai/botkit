...
controller.setupWebserver(process.env.port, function(err, webserver) {
    ...
    webserver.get('/', function(req, res) {
        ...
        var html =
            '<h1>Super Insecure Form</h1>' +
            '<p>Put text below and hit send - it will be sent to every team who has added your integration.</p>' +
            '<form method="post" action="/unsafe_endpoint">' +
