...
var INSTANCE_PUBLIC_SHAMING_MESSAGES = [ 'Remember to keep up the DoublePlusGood GoodThink vibes ' +
    'for our SafeSpace.', 'Remember, we\'re all in this together for the benefit of our Company.',
    'Let\'s stay positive! Remember: There\'s no I in team but there\'s an "eye" in this team. ;)',
    'We wouldn\'t want this to stay on our permanent record. Let\'s speak more positively' ];
var INSTANCE_PRIVATE_SHAMING_MESSAGES = [ 'Please remember to be civil. This will be on your HR ' +
    'file.', 'Only Happy fun times are allowed here. Remember GoodThink and PositiveVibes.',
    'Let\'s stay positive! Remember: There\'s no I in team but there\'s an "eye" in this team. ' +
    ';). Watching you.', 'Upbeat messages only. This has been logged to keep everyone safe.' ];
