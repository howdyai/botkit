...
|  Facebook | https://github.com/pinkku/botkit-middleware-facebookuser | This plugin provides Botkit developers a way to use the rasa facebook. Botkit Middleware to populate Facebook Messenger user info to a Botkit message<br/><br/><br/> |
