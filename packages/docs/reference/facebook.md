...
This is a class reference for all the methods exposed by the [botbuilder-adapter-facebook](https://github.com/howdyai/botkit/tree/next/packages/botbuilder-adapter-facebook) package.
