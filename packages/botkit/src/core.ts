...
export class Botkit {
     ...
     */
    public static incomingMessageToBotkitMessage(message: any): BotkitMessage {
        ...
        const activity = {
            ...
            event: channelData.type || message.type,
            text: message.text,
    ...
    public async handleTurn(turnContext: TurnContext): Promise<any> {
        ...
        const message = turnContext.activity as BotkitMessage;
        message.reference = TurnContext.getConversationReference(turnContext.activity);
        /*
