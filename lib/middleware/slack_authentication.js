var debug = require('debug')('slack:middleware:debug');
var log = require('debug')('slack:middleware:log');
...
function init(tokens) {
    ...
    if (authenticationTokens.length === 0) {
        log('No auth tokens provided, webhook endpoints will always reply HTTP 401.');
    }
