...
module.exports = function(config) {
    ...
    var teams_db = new Store(config.path + '/teams', opts);
    var users_db = new Store(config.path + '/users', opts);
    var channels_db = new Store(config.path + '/channels', opts);
