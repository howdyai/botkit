...
Precondition: the firebase should have three children named 'teams', 'channels', and 'users'.
...
module.exports = function(config) {
  ...
  if (!config && !config.firebase_uri) throw new Error('Need to provide firebase address. This should look something like "https://botkit-example.firebaseio.com/"');
