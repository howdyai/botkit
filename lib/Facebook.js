...
function Facebookbot(configuration) {
    ...
    var messenger_profile_api = {
        ...
        get_get_started: function() {
            facebook_botkit.api.messenger_profile.getAPI('get_started');
        },
        ...
        get_account_linking: function() {
            facebook_botkit.api.messenger_profile.getAPI('account_linking_url');
        },
