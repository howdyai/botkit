...
function Facebookbot(configuration) {
    ...
    var handover = {
        get_secondary_receivers_list: function(fields, cb) {
            request.get({
                url: 'https://' + api_host + '/' + api_version + '/me/secondary_receivers',
                qs: {
        ...
        take_thread_control: function(recipient, metadata, cb) {
            ...
            request.post({
                url: 'https://' + api_host + '/' + api_version + '/me/take_thread_control',
                qs: {
                    access_token: configuration.access_token
                },
                body: request_body,
        ...
        pass_thread_control: function(recipient, target, metadata, cb) {
            ...
            request.post({
                url: 'https://' + api_host + '/' + api_version + '/me/pass_thread_control',
                qs: {
                    access_token: configuration.access_token
                },
                body: request_body,
