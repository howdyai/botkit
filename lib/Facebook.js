...
function Facebookbot(configuration) {
                ...
                bot.findConversation({ user: message.user }, function(convo) {
                    if (convo) {
                        for (var s = 0; s < convo.sent.length; s++) {
                            if (
                                convo.sent[s].sent_timestamp <= message.delivery.watermark ||
                                (convo.sent[s].api_response &&
                                    convo.sent[s].api_response.message_id == mid)
                            ) {
    ...
    var messenger_profile_api = {
        ...
        postAPI: function(message) {
            ...
            request.post(uri, { form: message }, function(err, res, body) {
                if (err) {
                    ...
                    try {
                        ...
                        facebook_botkit.log(
                            'ERROR in messenger profile API call: Could not parse JSON',
                            err,
                            body
                        );
                    }
                    ...
                    if (results) {
                        if (results.error) {
                            facebook_botkit.log(
                                'ERROR in messenger profile API call: ',
                                results.error.message
                            );
                        } else {
                            facebook_botkit.debug(
                                'Successfully configured messenger profile',
                                body
                            );
                        }
                    }
        ...
        deleteAPI: function(type) {
            ...
            request.delete(uri, { form: message }, function(err, res, body) {
                if (err) {
                    facebook_botkit.log('Could not configure messenger profile');
                } else {
        ...
        get_messenger_code: function(image_size, cb, ref) {
            var uri =
                ...
                '/' +
                api_version +
                '/me/messenger_codes?access_token=' +
                configuration.access_token;
            ...
            request.post(uri, { form: message }, function(err, res, body) {
                if (err) {
                    ...
                    try {
                        ...
                        facebook_botkit.log(
                            'ERROR in messenger code API call: Could not parse JSON',
                            err,
                            body
                        );
                        if (cb) {
                    ...
                    if (results) {
                        if (results.error) {
                            facebook_botkit.log(
                                'ERROR in messenger code API call: ',
                                results.error.message
                            );
                            if (cb) {
                                cb(results.error);
            ...
            request.post(uri, { form: message }, function(err, res, body) {
                if (err) {
                    ...
                    try {
                        ...
                        facebook_botkit.log(
                            'ERROR in attachment upload API call: Could not parse JSON',
                            err,
                            body
                        );
                        if (cb) {
                    ...
                    if (results) {
                        if (results.error) {
                            facebook_botkit.log(
                                'ERROR in attachment upload API call: ',
                                results.error.message
                            );
                            if (cb) {
                                cb(results.error);
            ...
            request.get(uri, function(err, res, body) {
                if (err) {
                    ...
                    try {
                        ...
                        facebook_botkit.log(
                            'ERROR in page message tags call: Could not parse JSON',
                            err,
                            body
                        );
                        if (cb) {
            ...
            request.post(uri, {}, function(err, res, body) {
                if (err) {
                    ...
                    try {
                        ...
                        facebook_botkit.log(
                            'ERROR in build-in NLP API call: Could not parse JSON',
                            err,
                            body
                        );
                    }
            ...
            request.get(uri, {}, function(err, res, body) {
                if (err) {
                    ...
                    try {
                        ...
                        facebook_botkit.log(
                            'ERROR in user profile call: Could not parse JSON',
                            err,
                            body
                        );
                        if (cb) {
                    ...
                    if (results) {
                        if (results.error) {
                            facebook_botkit.log(
                                'ERROR in user profile API call: ',
                                results.error.message
                            );
                            if (cb) {
                                cb(results.error);
            ...
            request(
                ...
                function(err, res, body) {
                    if (err) {
                        ...
                        if (body.error) {
                            facebook_botkit.log(
                                'ERROR in Facebook Insights API call: ',
                                body.error.message
                            );
                            if (cb) {
                                cb(body.error);
            ...
            request.get(
                ...
                function(err, res, body) {
                    if (err) {
                        ...
                        if (body.error) {
                            facebook_botkit.log(
                                'ERROR in secondary receivers list: ',
                                body.error.message
                            );
                            if (cb) {
                                cb(body.error);
                            ...
                            facebook_botkit.debug(
                                'Successfully getting secondary receivers list',
                                body
                            );
                            if (cb) {
                                cb(null, body);
            ...
            request.post(
                ...
                function(err, res, body) {
                    if (err) {
                        ...
                        if (body.error) {
                            facebook_botkit.log(
                                'ERROR in take thread control API call: ',
                                body.error.message
                            );
                            if (cb) {
                                cb(body.error);
            ...
            request.post(
                ...
                function(err, res, body) {
                    if (err) {
                        ...
                        if (body.error) {
                            facebook_botkit.log(
                                'ERROR in pass thread control API call: ',
                                body.error.message
                            );
                            if (cb) {
                                cb(body.error);
            ...
            request.post(
                ...
                function(err, res, body) {
                    if (err) {
                        ...
                        if (body.error) {
                            facebook_botkit.log(
                                'ERROR in request thread control API call: ',
                                body.error.message
                            );
                            if (cb) {
                                cb(body.error);
    ...
    var broadcast_api = {
        create_message_creative: function(message, cb) {
            var uri =
                ...
                '/' +
                api_version +
                '/me/message_creatives?access_token=' +
                configuration.access_token;
            ...
            request(
                ...
                function(err, res, body) {
                    if (err) {
                        ...
                        if (body.error) {
                            facebook_botkit.log(
                                'ERROR in creating a broadcast message call: ',
                                body.error
                            );
                            if (cb) {
                                cb(body.error);
        ...
        send: function(message_creative, custom_label_id, cb) {
            var uri =
                ...
                '/' +
                api_version +
                '/me/broadcast_messages?access_token=' +
                configuration.access_token;
            var body = {};
            ...
            request(
                ...
                function(err, res, body) {
                    if (err) {
                        ...
                        if (body.error) {
                            facebook_botkit.log(
                                'ERROR in sending the broadcast message call : ',
                                body.error
                            );
                            if (cb) {
                                cb(body.error);
        ...
        get_broadcast_metrics: function(broadcast_id, cb) {
            var uri =
                ...
                '/' +
                broadcast_id +
                '/insights/messages_sent?access_token=' +
                configuration.access_token;
            ...
            request(
                ...
                function(err, res, body) {
                    if (err) {
                        ...
                        if (body.error) {
                            facebook_botkit.log(
                                'ERROR in getting broadcast metrics call : ',
                                body.error.message
                            );
                            if (cb) {
                                cb(body.error);
            ...
            request(
                ...
                function(err, res, body) {
                    if (err) {
                        ...
                        if (body.error) {
                            facebook_botkit.log(
                                'ERROR in creating label to target broadcast messages call : ',
                                body.error
                            );
                            if (cb) {
                                cb(body.error);
                            ...
                            facebook_botkit.debug(
                                'Successfully create label to target broadcast messages',
                                body
                            );
                            if (cb) {
                                cb(null, body);
            ...
            request(
                ...
                function(err, res, body) {
                    if (err) {
                        ...
                        if (body.error) {
                            facebook_botkit.log(
                                'ERROR in adding a user to a label API call : ',
                                body.error
                            );
                            if (cb) {
                                cb(body.error);
            ...
            request(
                ...
                function(err, res, body) {
                    if (err) {
                        ...
                        if (body.error) {
                            facebook_botkit.log(
                                'ERROR in removing a user from a label API call : ',
                                body.error
                            );
                            if (cb) {
                                cb(body.error);
            ...
            request(
                ...
                function(err, res, body) {
                    if (err) {
                        ...
                        if (body.error) {
                            facebook_botkit.log(
                                'ERROR in getting user associated labels API call : ',
                                body.error.message
                            );
                            if (cb) {
                                cb(body.error);
            ...
            request(
                ...
                function(err, res, body) {
                    if (err) {
                        ...
                        if (body.error) {
                            facebook_botkit.log(
                                'ERROR in getting label details call : ',
                                body.error.message
                            );
                            if (cb) {
                                cb(body.error);
