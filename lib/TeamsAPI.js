    ...
    var api = {
        request: function(options, cb) {
            ...
            request(options, function(err, res, body) {
                ...
                if (!body) {
                    if (cb) {
                        return cb('Error parsing json response');
                    }
                }
        ...
        addMessageToConversation: function(conversationId, message, cb) {
            var uri =
                configuration.serviceUrl + 'v3/conversations/' + conversationId + '/activities';
        ...
        getTeamRoster: function(conversation_id, cb) {
            var uri =
                configuration.serviceUrl + 'v3/conversations/' + conversation_id + '/members/';
            api.request(
                {
                    method: 'GET',
                    json: true,
