...
function Sparkbot(configuration) {
    ...
    controller.defineBot(function(botkit, config) {
        ...
        bot.startPrivateConversation = function(message, cb) {
            ...
            // if a user is specified, use that -- this happens when a user says something
            // otherwise, use the actorId - this might happen when a user takes an action
            // for example, if a user adds a bot to the channel...
            if (message.user) {
              message_options.toPersonEmail = message.user;
            } else if (message.original_message.actorId) {
              message_options.toPersonId = message.original_message.actorId;
            }
        ...
        bot.send = function(message, cb) {
            ...
            // default the markdown field to be the same as text.
