...
function TeamsBot(configuration) {
    ...
    controller.middleware.categorize.use(function(bot, message, next) {
        if (message.type == 'conversationUpdate') {
            if (message.raw_message.membersAdded) {
                ...
                message.raw_message.channelData &&
                message.raw_message.channelData.eventType
            ) {
                // channelCreated
                // channelDeleted
                // channelRenamed
    ...
    controller.middleware.send.use(function(bot, message, next) {
        ...
        if ((matches = message.text.match(/\<\@(.*?)\>/gim))) {
