...
module.exports = function(studio){
  ...
  function statsAPI(bot,options){
    ...
    return new Promise(function(resolve, reject){
      ...
      console.log('options: ', options);
      // {
      // 	"bot_id" : "57aa3d7a0ad2d25213454120",
      // 	"botHash" : "18a1a17a33e7eb439bce431102d8f438",
      // 	"channel" : "6972de9cd6c1389275a2e8a456694512",
      // 	"user" : "fe0db28630c293c6756b8a4621f45d78",
      // 	"team" : "161b45ae44118d10ef51e743774b1014",
      // 	"type" : "remote_command_end",
      // 	"time" : ISODate("2016-08-15T21:55:37Z"),
      // 	"meta" : {
      // 		"user" : "fe0db28630c293c6756b8a4621f45d78",
      // 		"channel" : "6972de9cd6c1389275a2e8a456694512",
      // 		"command" : "hello",
      // 		"timestamp" : "Tue Aug 09 2016 20:30:51 GMT+0000 (UTC)",
      // 		"conversation_length" : "1110",
      // 		"status" : "completed"
      // 	},
      // 	"_id" : ObjectId("57b23a59be7fa3d62e0c8a3a")
      // }
