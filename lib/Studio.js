...
var _STUDIO_COMMAND_API = 'http://api.botkit.ai';
var _STUDIO_STATS_API = 'http://stats.botkit.ai';
...
module.exports = function(controller){
  ...
  function studioAPI(bot,options){
    return new Promise(function(resolve, reject){
      ...
      } else if (controller.config.howdy_token) {
          console.log('Using shared authenticated session');
          options.uri = options.uri + '?access_token=' + controller.config.howdy_token;
      }else {
