...
module.exports = function(controller){
      ...
      return new Promise(function(resolve,reject) {
          controller.studio.get(bot, message.text).then(function(command) {
              ...
              controller.trigger('command_triggered', [bot, message, command]);
                controller.studio.compileScript(bot, message, command.command, command.script, command.variables).then(function(convo) {
  ...
  // tutorial functions
  controller.tutorial.getDailySpecial = function(){
    var special = {
      name: 'Tom Kha Gai',
  ...
  controller.tutorial.getMenu = function(){
    var menu = [
      {
        name: 'Albondigas',
        description: 'A traditional Mexican meatball soup made with sauteed onions, garlic, broth, and tomatoes.',
        price: '5.00'
      },
      {
        name: 'Borscht',
      ...
      {
        name: 'Bouillabaisse',
        description: 'Bouillabaisse, originating all the way from the city of Marseille of France, is usually a fish stock containing different kinds of cooked fish and shellfish which usually are complemented with garlic, orange peel, basil, bay leaf, fennel and saffron.',
        price: '5.00'
      },
      {
      ...
      {
        name: 'Gazpacho',
        description: 'Gazpacho is a concoction of bread, tomato, bell pepper, garlic, olive oil, salt and vinegar.',
        price: '5.00'
      }
    ];
    return menu;
