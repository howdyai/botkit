...
module.exports = function(controller) {
    ...
    // get command list
    controller.studio.getScripts = function(bot) {
        var sdk = new SDK(genConfig(bot || {}));
        return sdk.getScripts();
    };
                                ...
                                if (topics[t].script[m].platforms && topics[t].script[m].platforms.web) {
                                    ...
                                    if (topics[t].script[m].platforms.web.files) {
                                        ...
                                        for (var f = 0; f < topics[t].script[m].platforms.web.files.length; f++) {
                                            ...
                                            topics[t].script[m].platforms.web.files[f].image = (topics[t].script[m].platforms.web.files[f].url.match(/\.(jpeg|jpg|gif|png)$/i) != null);
