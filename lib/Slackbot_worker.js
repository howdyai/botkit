        ...
        bot.api.rtm.connect({}, function(err, res) {
            ...
            bot.rtm.on('open', function() {
                ...
                bot.rtm.on('message', function(data) {
                    ...
                    } else if (message != null && bot.botkit.config.rtm_receive_events_whitelist && bot.botkit.config.rtm_receive_events_whitelist.includes(message.type)) {
                        /*
                        * Allow a event to be ingested by the bot
                        * even if rtm_receive_messages is disabled
                        */
                        botkit.ingest(bot, message, bot.rtm);
                    }
                });
