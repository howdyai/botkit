...
var chatInjection = require('./controllers/ChatInjection');
...
function BotFrameworkBot(configuration) {
    ...
    bf_botkit.createInjectionEndpoint = function(webserver, config, cb) {
        webserver.get('/botframework/chat-injection', chatInjection(config, cb));
    };
