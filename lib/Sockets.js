            ...
            bot.getInstanceInfo = function(cb) {
                ...
                return new Promise(function(resolve, reject) {
                    ...
                    if (controller.studio_identity) {
                      instance.identity.name = controller.studio_identity.name;
                      instance.identity.id = controller.studio_identity.botkit_studio_id;

                      instance.team.name = controller.studio_identity.name;
                      instance.team.url = controller.studio_identity.root_url;
                      instance.team.id = controller.studio_identity.botkit_studio_id;
