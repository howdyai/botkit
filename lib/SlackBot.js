                        ...
                        if (team.bot.identity == undefined || team.bot.identity.id == null) {
                            ...
                            bot.identifyBot(function(err, identity) {
                                ...
                                if (req.body.event.type === 'message') {
                                    ...
                                    // Event is not a message, trigger event type
                ...
                if (err) {
                  ...
                  console.log('==============AUTH:\n',auth)
                    ...
                    auth_test({
                      ...
                      console.log('==============AUTH_TEST IDENTITY:\n', identity)
                        ...
                        if (err) {
                            ...
                            slack_botkit.findTeamById(identity.team_id, function(err, team) {
                                ...
                                if (auth.bot) {
                                  // var botName
                                  // call_api('auth.test', {token: team.id}, function(err, data) {
                                  //     if (err) {
                                  ...
                                  //   slack_botkit.storage.teams.get(identity.team_id, function(err, team) {
                                  //     if (err) {
                                  //       console.log(err)
                                  //     }
                                  //     else {
                                  //       console.log('======TEAM DATA FROM STORAGE\n',team)
                                  //     // team.bot.name = botName
                                  //     // slack_botkit.saveTeam(team)
                                  //   }
                                  // })
                                }
