        ...
        wss.on('connection', function connection(ws) {
            ...
            ws.on('message', function incoming(message) {
                try {
                    ...
                    console.error(`Error parsing incoming message from websocket.  Message must be JSON, and should be in the format documented here: https://botkit.ai/docs/readme-web.html#message-objects`);
                    console.error(e);
                } 
