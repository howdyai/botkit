...
module.exports = function(bot, config) {
    ...
    function postForm(url, formData, cb, multipart) {
        ...
        request.post(params, function(error, response, body) {
            bot.info("Status Code: ", response ? response.statusCode : "NO STATUS CODE (INFO)");
            bot.debug("Status Code: ", response ? response.statusCode : "NO STATUS CODE");
            bot.debug("Body: ", body ? body : "NO BODY");
            bot.debug('Got response', error, body, response);
