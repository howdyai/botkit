...
function Botkit(configuration) {
    ...
    **/
    ...
    if (configuration.logger) {
        util.ensureMethodsArePresent('logger', configuration.logger, ['log']);
    ...
    if (configuration.storage) {
        util.ensureMethodsArePresent('storage', configuration.storage, [
            'teams.get', 'teams.save', 'users.get', 'users.save', 'channels.get', 'channels.save'
        ]);
