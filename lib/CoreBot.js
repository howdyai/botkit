...
var sqlite_storage = require(__dirname + '/storage/sqlite_storage.js');
...
function Botkit(configuration) {
    ...
    } else if (configuration.sqlite_store) {
        botkit.log('** Using SQLite storage. Saving data to ' + configuration.sqlite_store);
        botkit.storage = sqlite_storage({path: configuration.sqlite_store});
    } else {
