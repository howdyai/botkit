                ...
                switch (conditional.action) {
                    case 'execute_script':
                        if (conditional.execute) {
                            ...
                            controller.studio.get(that.context.bot, script, that.source_message.user, that.source_message.channel, that.source_message).then(function(new_convo) {
                    ...
                    break;
                    default:
                        that.changeTopic(conditional.action);
                    break;
                }
            }
