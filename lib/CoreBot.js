    ...
    function Conversation(task, message) {
        ...
        this.handleAction = function(condition) {
            ...
            switch (condition.action) {
                ...
                case 'repeat':
                    ...
                    // TODO: do studio scripts need to repeat in a different way than others??
                    // TODO: Should repeats be unified?
        ...
        this.repeat = function() {
            if (this.sent.length) {
              ...
              // if not, unshift it to the front so it doesn't repeat AFTEr other messages
              if (!this.messages.length) {
                this.messages.push(this.sent[this.sent.length - 1]);
              } else {
                this.messages.unshift(this.sent[this.sent.length - 1]);
              }
            } else {
